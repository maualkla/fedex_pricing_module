...
var xmlBlock = '<RateRequest xmlns="http://fedex.com/ws/rate/v13">' +
  ...
  '<RequestedShipment>'+
    ...
    '<Shipper>'+
      '<Address>'+
        ...
        '<PostalCode>' + quote_params.addres_from.zip + '</PostalCode>'+
        '<CountryCode>' + quote_params.addres_from.country + '</CountryCode>'+
      '</Address>'+
    '</Shipper>'+
    '<Recipient>'+
      '<Address>'+
        ...
        '<City></City>'+
        '<StateOrProvinceCode>XX</StateOrProvinceCode>'+
        '<PostalCode>' + quote_params.addres_to.zip + '</PostalCode>'+
        '<CountryCode>' + quote_params.addres_to.country + '</CountryCode>'+
